...
<head>
  ...
  <link rel="stylesheet" href="../../web/modules/bootstrap/css/bootstrap.css">
  <link rel="stylesheet" href="../../web/modules/bootstrap/css/bootstrap.min.css">
  <link rel="stylesheet" href="../../web/modules/ionicons/css/ionicons.min.css">
  <link rel="stylesheet" href="../../web/modules/fontawesome/web-fonts-with-css/css/fontawesome-all.min.css">

  <link rel="stylesheet" href="../../web/modules/summernote/summernote-lite.css">
  <link rel="stylesheet" href="../../web/modules/flag-icon-css/css/flag-icon.min.css">
...
管理员
  ...
  <script src="../../web/modules/jquery.min.js"></script>
  <script src="../../web/modules/popper.js"></script>
  <script src="../../web/modules/tooltip.js"></script>
  <script src="../../web/modules/bootstrap/js/bootstrap.min.js"></script>
  <script src="../../web/modules/nicescroll/jquery.nicescroll.min.js"></script>
  <script src="../../web/modules/scroll-up-bar/dist/scroll-up-bar.min.js"></script>
  <script src="../../web/js/sa-functions.js"></script>

  <script src="../../web/modules/chart.min.js"></script>
  <script src="../../web/modules/summernote/summernote-lite.js"></script>
